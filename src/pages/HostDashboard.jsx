...
export default function HostDashboard() {
  ...
  const [deleteConfirm, setDeleteConfirm] = useState(null); // property id
  ...
  const handleDeleteProperty = async (propertyId) => {
    ...
    try {
      ...
      setHostListings((prev) => prev.filter((l) => l.id !== propertyId));
                  ...
                  <div key={listing.id} className="border border-line rounded-2xl overflow-hidden bg-white">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex gap-2 mt-4 pt-4 border-t border-slate-100">
                        <button
                          onClick={() => navigate(`/host/add-property?edit=${listing.id}`)}
                        ...
                        <button
                          ...
                          className="flex-1 rounded-lg border border-red-200 py-2 text-xs font-bold text-red-600 hover:bg-red-50"
                        >
                          Delete
                        </button>
                      </div>
      ...
      {deleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
            ...
            <p className="mt-2 text-sm text-slate-500">This will permanently remove the listing and cancel any pending bookings. This cannot be undone.</p>
